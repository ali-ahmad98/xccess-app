        ...
        <div id="myModalRegister" class="modal">
            ...
            <section id="content">
                <div class="modal-header">
                    <span onClick={closeHandler} class="close spanClose">&times;</span>
                </div>
                ...
                <form action="">
                    <h1>Register </h1>
                    <div>
                        <input type="text" placeholder="Your Name" required="" id="username" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span className="spanLinkStyles" onClick={moveToLoginHandler} >Already have Account? Login</span>
